...
colours = {}
input_fn = lambda do
  # We add the current position to the painted squares here (when collecting input),
  # because the square isn't painted until input is requested
  squares << robot_position.to_s
